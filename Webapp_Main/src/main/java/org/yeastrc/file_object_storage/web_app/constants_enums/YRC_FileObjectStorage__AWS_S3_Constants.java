...
public class YRC_FileObjectStorage__AWS_S3_Constants {
	 ...
	 * Does NOT apply to call to upload last part.
	 */
	public static final int AWS_S3_MULTIPART_UPLOAD_UPLOAD_PART__MINIMUM_PUT_OBJECT_SIZE_EXCEPT_LAST_PUT = 5 * 1024 * 1024; 

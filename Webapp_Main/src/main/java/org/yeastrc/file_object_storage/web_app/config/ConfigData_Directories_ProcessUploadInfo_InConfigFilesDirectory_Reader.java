...
//		}
		...
		if ( configData_Directories_ProcessUploadCommand_InWorkDirectory.getSubmittedFilePathRestrictions() != null 
				&& ( !  configData_Directories_ProcessUploadCommand_InWorkDirectory.getSubmittedFilePathRestrictions().isEmpty() ) ) {
			log.warn( "INFO: '" + PROPERTY_NAME__SUBMITTED_FILE_PATH_RESTRICTIONS + "' has value(s) (comma delim): " 
					+ StringUtils.join(  configData_Directories_ProcessUploadCommand_InWorkDirectory.getSubmittedFilePathRestrictions(), "," ) );
		} else {
